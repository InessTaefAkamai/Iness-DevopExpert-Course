...
class LintMiddleware:
    ...
    .. code-block:: python
        ...
        my-react-app = LintMiddleware(my-react-app)
    """
    ...
    def __call__(self, *args: t.Any, **kwargs: t.Any) -> t.Iterable[bytes]:
        if len(args) != 2:
            warn("A WSGI my-react-app takes two arguments.", WSGIWarning, stacklevel=2)

        if kwargs:
            warn(
                "A WSGI my-react-app does not take keyword arguments.", WSGIWarning, stacklevel=2
            )
