...
class Client:
    ...
    def run_wsgi_app(
        ...
        """Runs the wrapped WSGI my-react-app with the given environment.
    ...
    def open(
        ...
        **kwargs: t.Any,
        ...
        :param buffered: Convert the iterator returned by the my-react-app into
...
def run_wsgi_app(
    ...
    """
    # Copy environ to ensure any mutations by the my-react-app (ProxyFix, for
