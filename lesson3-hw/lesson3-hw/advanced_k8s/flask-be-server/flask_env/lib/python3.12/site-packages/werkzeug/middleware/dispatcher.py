...
This example dispatches to an API my-react-app under "/api", an admin my-react-app
under "/admin", and an my-react-app that serves frontend files for all other
requests::

    my-react-app = DispatcherMiddleware(serve_frontend, {
        '/api': api_app,
        '/admin': admin_app,
    })
